        ...
        <div class="col-lg-12 mb-2">
            <div class="card shadow-sm">
                <div class="card-header">
                    <h2>Order Details
                        <a onclick="window.location.href='index.php?table_no=<?php echo $orderDetails['table_no']; ?>';" class="btn btn-danger float-end">Back to Orders</a>
                    </h2>
                </div>
                ...
                <div class="card-footer text-start">
                    ...
                    <!-- Send Receipt Form -->
                    <form method="POST" id="sendReceiptForm" style="margin-top: 15px;">
                        <input type="email" name="recipient_email" class="form-control mb-2" placeholder="Enter recipient email" required style="width: 250px;">
