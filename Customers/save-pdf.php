...
if (isset($_GET['order_id'])) {
    ...
    // Retrieve order details including customer data and invoice_no
    $orderQuery = "
        SELECT 
            orders.table_no, 
            orders.total_price, 
    ...
    $pdf->Cell(0, 8, 'Customer Name: ' . $orderDetails['customer_name'], 0, 1);
    $pdf->Cell(0, 8, 'Customer Phone: ' . $orderDetails['customer_phone'], 0, 1);
    $pdf->Cell(0, 8, 'Customer Email: ' . $orderDetails['customer_email'], 0, 1);
    $pdf->Ln(5);
