    ...
    <div class="card mt-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            if (!isset($_SESSION['customerUser'])) {
                header("Location: ../CLogin/login.php");
                exit();
            }

            // Get the logged-in customer's ID
            $customer_id = $_SESSION['customerUser']['id'];
            ...
            // Query to get orders grouped by date for the selected month, year, and customer
            $orderQuery = "
                ...
                WHERE orders.customer_id = $customer_id  -- Filter by logged-in customer's orders
