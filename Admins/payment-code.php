...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['makePayment'])) {
    ...
    if (isset($_SESSION['menuItems']) && count($_SESSION['menuItems']) > 0) {
        ...
        $currentDate = date('Ymd');  // Format: 20241119 (e.g., Year-Month-Day)
        $currentTime = date('His');  // Format: 185600 (e.g., Hour-Minute-Second)
        ...
        $orderQuery = "INSERT INTO orders (table_no, total_price, invoice_no, order_date) 
